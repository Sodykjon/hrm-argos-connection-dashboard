...
export const UZ = {
  ...
  kadrlar: {
    levelsDivider: "Вилоятларга кирмайдиган муассасалар",
    levelsNote: (n: string) =>
      `«Республика муассасалари» — вилоятларга бириктирилмаган, республика тобелигидаги ташкилотлар: РИИАТМ ва илмий-текшириш институтлари, республика шифохоналари, вазирлик марказий аппарати. Бу ҳудуд эмас, шу боис харитада ҳам, рейтингда ҳам йўқ, лекин жадвалда қолдирилди — усиз ${n} нафар ходим йўқолиб, жадвал миллий якунга тўғри келмас эди. АРГОСда бундан ташқари «Туман/шаҳар даражаси» деган тармоқ бор; унда битта республика кўз шифохонаси турибди, яъни нотўғри таснифланган — шунинг учун шу қаторга қўшиб ҳисобланди.`,
  },
  ...
  pension: {
    ...
    count: (geo: number, levels: number) =>
      levels > 0
        ? `${geo} та ҳудуд · вилоятдан ташқари ${levels} қатор`
        : `${geo} та ҳудуд`,

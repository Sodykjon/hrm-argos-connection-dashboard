...
export const UZ = {
  ...
  overview: {
    ...
    attentionHintCount: "Уланмаганлар сони энг кўп 3 ҳудуд",
    attentionShare: (pct: string, region: string) => `Уланмаганларнинг ${pct} — ${region}да`,
    shareOfUnconnected: (pct: string) => `уланмаганларнинг ${pct}`,
    deltaSince: (d: string) => `${d} ҳолатига нисбатан`,
    deltaHero: (n: string, d: string) => `${d} дан бери ${n} ташкилот уланди`,
    deltaConnected: "Янги уланганлар",
    deltaUnconnected: "Уланмаганлар ўзгариши",
    deltaDeleted: "Ўчирилганлар ўзгариши",
    deltaRate: "Уланиш даражаси ўзгариши",
    noChange: "ўзгариш йўқ",
    mapScale: "Ранг шкаласи 50–100% (50% ва ундан паст — қизил)",
  ...
  pension: {
    ...
    waveZoneNote: (count: string, share: string) =>
      `50+ ёшдагилар — ${count} нафар (${share}): келгуси ўн йилликнинг пенсия тўлқини шу қатламдан чиқади`,
  ...
  vakansiya: {
    ...
    absTitle: "Бўш ўринлар қаерда тўпланган",
    absHint: "мутлақ сон · умумийдаги улуш",
    absShareNote: (name: string, share: string) =>
      `Фоиз рейтинги кичик штатли ҳудудни юқорига чиқариши мумкин; юкнинг ўзи эса бошқача тақсимланган — ${name} якка ўзи барча бўш ўринларнинг ${share} қисмини ушлаб турибди`,
  ...
  tarkib: {
    ...
    heroJismoniy: "жисмоний врачлар банд қилган",
    heroDecompNote:
      "Расмий вакансия кўрсаткичи яширин бўшлиқни ҳисобга олмайди: ўриндошлик билан ёпилган ўринлар ҳам аслида жисмоний врачсиз",
    flagBelow: (t: string) => `${t} дан паст — эътибор талаб қилади`,
    waveFlag: "пенсия тўлқини",
    waveFlagTitle: (p: string) =>
      `Ходимларининг ${p} қисми пенсия ёшида — тақчиллик яқин йилларда чуқурлашади`,
    over100Hint: "100% дан ошиши — ўриндошлик ҳисобига",
    ...
    terms:
      "Изоҳ: Таъминланиш — ишлаётган ходимлар сонининг штат бирликларига нисбати (100% дан ошиши мумкин). Ўриндошлик — бир ходим эгаллаган ўртача ставка (1,30 бўлса, ҳар ходим ўртача 1,3 ставкада ишлайди). Пенсия хавфи — пенсия ёшидагилар ва 5 йил ичида пенсия ёшига етадиганлар улуши. Йиллик оқим — йил давомида қабул қилинганлар минус ишдан бўшаганлар.",
    qualityNote:
    ...
    spec: {
      title: "Мутахассисликлар кесими",
      subtitle:
        "Ҳар бир лавозим бўйича бандлик, таъминланиш ва танқислик — 237 мутахассислик, 14 ҳудуд",
      navBtn: "Барча мутахассисликлар кесими",
      search: "Мутахассислик номи бўйича қидириш… (мас. кардиолог)",
      all: "Барчаси",
      count: (n: number) => `${n} та лавозим`,
      sortedByGap: "танқислик бўйича сараланган",
      empty: "Мос лавозим топилмади.",
      grpShort: {
        vrach: "Врачлар",
        orta: "Ўрта тиб.",
        kichik: "Кичик тиб.",
      ...
      kpi: {
        shtat: "Штат бирликлари",
        shtatHint: "тасдиқланган иш ўринлари",
        jismoniy: "Ишлаётган ходимлар",
        jismoniyHint: "жисмоний шахслар",
        taminl: "Таъминланиш",
        taminlHint: "ходимлар ÷ штат",
        gap: "Етишмаётган ставка",
        gapHint: "штат − ходимлар",
        bosh: "Расман бўш ўринлар",
        boshHint: "вакансия деб кўрсатилган",
        koef: "Ўриндошлик",
        koefHint: "1 ходимга ўртача ставка",
        pens: "Пенсия ёшида",
        pensHint: "ишлаётганлар ичида",
        r5: "Пенсия хавфи (5 йил)",
        r5Hint: "пенсия ёшида + яқинлашганлар",
      },
      listUnit: (j: string, s: string) => `${j} киши · штат ${s}`,
      clickHint: "туманларини кўриш учун ҳудудни босинг",
      distLoading: "Туманлар юкланмоқда…",
      ...
      barNote:
        "Оқ чизиқ — штат тўлиқ банд бўлган нуқта (100%). Ранглар: 50% ва ундан паст — қизил (ҳар иккинчи ўрин бўш), 100% ва ундан юқори — яшил.",
      tableTitle: "Ҳудудлар кесими",
      brokenNote:
        "«—» — айрим ҳудудларда ушбу лавозимнинг манба қатори ички текширувдан ўтмади (устунлар силжиган), шу боис пенсия/декрет маълумоти кўрсатилмади; штат ва жисмоний сон ишончли — улар алоҳида варақдан олинган.",
    }
  },
  ...
  argosLive: {
    ...
    subtitle:
      "hrm.argos.uz ташкилотлар дарахти ва биллинг ҳолати асосида, 17.09.2026 реестридаги ташкилотлар бўйича ҳисобланади.",
    lastRead: "ARGOS дарахти ўзгарган вақт",
    lastChecked: "Сўнгги текширув",
    stale: "Маълумот 30 дақиқадан эски — hrm.argos.uz вкладкаси ёпилган ёки сессия тугаган бўлиши мумкин.",
    empty:
      "Ҳали ARGOS маълумоти юборилмаган. «Ўрнатиш» саҳифасидаги хатчўпни hrm.argos.uz'да бир марта босинг.",
    setup: "Хатчўпни ўрнатиш",
    autoRefresh: "Саҳифа ҳар 2 дақиқада ўзи янгиланади",
    orgsInTree: (n: string) => `ARGOS дарахтида ${n} ташкилот`,
    changesTitle: "Сўнгги ўзгаришлар",
    changesHint: (d: string) => `${d} даги дарахтга нисбатан`,
    noChanges: "Олдинги дарахтга нисбатан ҳолати ўзгарган ташкилот йўқ.",
    regionTableTitle: "Ҳудудлар кесимида",
    regionTableHint: "Энг паст уланишдан юқорига. Ҳудуд номини босинг — туманлар ва ташкилотлар.",
    districts: "Туманлар кесимида",
    orgs: "Ташкилотлар",
    search: "Номи ёки СТИР бўйича қидириш…",
    allStatuses: "Барча ҳолатлар",
    shown: (n: string, t: string) => `${n} / ${t} кўрсатилмоқда`,
    col: {
      region: "Ҳудуд",
    ...
    billingOn: "фаол",
    billingOff: "нофаол",
    notInTree: "дарахтда йўқ",
    reasons: {
      override: "Қўлда белгиланган",
      nostir: "СТИР йўқ — реестр ҳолати",
      missing: "ARGOS дарахтида йўқ",
      billing: "Дарахтда, биллинг фаол",
      newBilling0: "Янги уланган, биллинг ҳали ёқилмаган",
      billingOff: "Дарахтда, биллинг нофаол",
    },
    attention: {
      title: "Эътибор талаб қиладиганлар",
      newConn: "Янги уланганлар (биллинг кутилмоқда)",
      billingOff: "Реестрда фаол, биллинг нофаол",
      missing: "Реестрда фаол, ARGOS'да йўқ",
      stir: "Бир хил СТИР",
      extra: "ARGOS'да бор, реестрда йўқ",
      stirHint:
        "Бир СТИР остида бир нечта ташкилот ёзилган — одатда туман тиббиёт бирлашмаси ва унинг ОП/ОШПлари. ARGOS'да кўпинча фақат бирлашманинг ўзи туради, шунинг учун бу сатрларнинг «уланган» ҳолати текширилиши керак.",
      mixed: "ҳолатлари ҳар хил",
      none: "Йўқ",
    },
    export: "Excel'га юклаб олиш",
    back: "Барча ҳудудлар",
    receiver: {
      title: "ARGOS маълумотини қабул қилиш",
      waiting: "hrm.argos.uz вкладкасидан маълумот кутилмоқда…",
      password: "Админ пароли",
      passwordHint: "Бир марта киритилади ва фақат шу вкладка ёпилгунча сақланади.",
      save: "Сақлаш",
      received: (n: string) => `${n} та ташкилот қабул қилинди`,
      saved: "Сақланди",
      unchanged: "Ўзгариш йўқ — текширув вақти янгиланди",
      errAuth: "Парол нотўғри",
      errBad: "Маълумот нотўғри форматда",
      errServer: "Сервер хатоси",
      keepOpen: "Бу вкладкани ёпманг: hrm.argos.uz ҳар 10 дақиқада маълумотни шу ерга юборади.",
      open: "Жонли саҳифани очиш",
    },
    install: {
      title: "Хатчўпни ўрнатиш",
      step1: "Қуйидаги тугмани сичқонча билан браузернинг хатчўплар панелига судраб ташланг.",
      step2: "hrm.argos.uz'га киринг ва шу хатчўпни босинг.",
      step3: "Янги вкладка очилади — биринчи марта админ паролини киритинг.",
      step4: "Иккала вкладка очиқ турса, маълумот ҳар 10 дақиқада ўзи янгиланади.",
      button: "ARGOS жонли",
      note: "Хатчўп фақат сизнинг браузерингизда, сизнинг ARGOS сессиянгиз орқали ишлайди: ҳеч қандай парол сақланмайди, ARGOS'га бошқа ҳеч ким мурожаат қилмайди.",
      copy: "Ёки кодни нусхалаб, қўлда хатчўп яратинг:",
    },
  },
  units: {
    org: "ташкилот",

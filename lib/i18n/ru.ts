...
export const RU = {
  ...
  pension: {
    ...
    waveTitle: "Волна замещения",
    waveHint: "Сколько сегодняшних сотрудников перешагнут 60 лет",
    wave: {
      now: "Сейчас старше 60 лет",
      y10: "Исполнится 60 в течение 10 лет",
      y20: "Исполнится 60 в течение 20 лет",
    },
    waveNote:
      "Расчёт опирается только на возрастные группы сегодняшних сотрудников — приём и увольнение не учитываются. 60 лет здесь граница возрастной группы в отчёте, а не пенсионный возраст.",
    ...
    sourceNote: (date: string) =>
      `Источник: hrm.argos.uz — отчёт «Возрастное распределение сотрудников», по состоянию на ${date}. Отчёт учитывает фактически работающих сотрудников; в других отчётах системы охват может отличаться.`,

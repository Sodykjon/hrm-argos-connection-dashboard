...
export const RU = {
  ...
  kadrlar: {
    levelsDivider: "Уровни АРГОС — не области",
    levelsNote: (n: string) =>
      `«Республиканский уровень» и «Районный/городской уровень» — не области, а отдельные ветви организационного дерева АРГОС. В первую входят республиканские учреждения: РСНПМЦ и научно-исследовательские институты, республиканские больницы, центральный аппарат министерства — они не закреплены ни за одной областью и поэтому не показаны ни на карте, ни в рейтинге. Вторая в АРГОС почти пуста; все остальные районные и городские учреждения учитываются внутри своей области. Обе строки оставлены в таблице: без них исчезли бы ${n} сотрудников и таблица не сошлась бы с национальным итогом.`,
  },
  ...
  pension: {
    ...
    count: (geo: number, levels: number) =>
      levels > 0
        ? `Регионов: ${geo} · уровней АРГОС: ${levels}`
        : `Регионов: ${geo}`,

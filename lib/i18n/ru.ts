...
export const RU = {
  ...
  kadrlar: {
    levelsDivider: "Учреждения вне областей",
    levelsNote: (n: string) =>
      `«Республиканские учреждения» — организации республиканского подчинения, не закреплённые за областями: РСНПМЦ и научно-исследовательские институты, республиканские больницы, центральный аппарат министерства. Это не регион, поэтому их нет ни на карте, ни в рейтинге, но в таблице они оставлены: без них исчезли бы ${n} сотрудников и таблица не сошлась бы с национальным итогом. В АРГОС есть также ветвь «Районный/городской уровень» — в ней одна республиканская глазная больница, то есть классификация неверна, поэтому она учтена в этой же строке.`,
  },
  ...
  pension: {
    ...
    count: (geo: number, levels: number) =>
      levels > 0
        ? `Регионов: ${geo} · вне областей: ${levels}`
        : `Регионов: ${geo}`,

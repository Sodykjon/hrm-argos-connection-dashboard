...
export const RU = {
  ...
  vakansiya: {
    ...
    turnoverNote:
      "Показатель приёма по Самаркандской области отражает массовый ввод организаций в АРГОС, а не реальный наём: проверка 06.08.2026 показала, что 133 из 224 организаций зарегистрировали более 80% всего штата как «принятых» именно в этом периоде (уволенных всего 644).",
    accepted: "Принято",
    dismissed: "Уволено",
